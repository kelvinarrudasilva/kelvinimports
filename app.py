...
with tabs[2]:
    ...
    .glass-card { background: rgba(255,255,255,0.03); border-radius:14px; padding:12px; backdrop-filter: blur(6px); border:1px solid rgba(255,255,255,0.05); box-shadow:0 6px 24px rgba(0,0,0,0.6); }
